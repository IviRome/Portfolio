...
public class ReadTagActivity extends Activity {
    ...
    private static final String TAG = "gti";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewData = (TextView)findViewById(R.id.tag_viewer_text);
        ...
        try {
            ndefDetected.addDataType("application/com.diana.grupo3.gti.nfc");
